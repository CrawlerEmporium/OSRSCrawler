...
class Info(commands.Cog):
    ...
    async def botinfo(self, ctx):
        ...
        em = discord.Embed(color=discord.Color.green(), description="OSRSCrawler, a bot for stuff and things.")
        em.title = 'Bot Info'
        ...
        em.add_field(name="About",
                     value='An Oldschool Runescape bot made by LordDusk#0001 .\n[Support Server](https://discord.gg/HEY6BWj)')
        em.set_footer(text=f"OSRSCrawler {ctx.bot.version} | Powered by discord.py")
    ...
    async def support(self, ctx):
        ...
        em.description = "So you want support for OSRSCrawler? You can easily join my discord [here](https://discord.gg/HEY6BWj).\n" \
